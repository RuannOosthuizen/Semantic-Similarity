...
####-----NOTES-----#####
"""
As I performed the process firstly with "en_core_web_md" and then "en_core_web_sm", I noted that the "en_core_web_md" and "en_core_web_sm"
models differ in terms of size, performance, similarity scores, and computational resource requirements.
The "en_core_web_md" model is larger and provides higher accuracy due to its larger parameter size, making it more
suitable for tasks requiring complex linguistic analysis and capturing nuanced semantic relationships.
On the other hand, "en_core_web_sm" is a smaller model that requires fewer computational resources, making it a preferable choice when working with limited resources.
The similarity scores between tokens in complaints and recipes will generally be higher with "en_core_web_md" compared to "en_core_web_sm."
However, the specific performance differences may vary depending on the text and task at hand.
It is recommended to test both models to determine the most suitable one for your specific requirements.
"""